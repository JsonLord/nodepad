...
export interface Delegation { id:string; taskEntityId?:string; projectEntityId?:string; requestedBy:"user"|"hermes"|"system"; agentProfileId?:string; routingRuleId?:string; routingDecisionId?:string; status:DelegationStatus; request:DelegationRequest; externalProvider?:"agtx"; externalRunId?:string; dispatchAuthorizedAt?:number; dispatchAuthorizedBy?:"user"|"hermes"|"system"; lastExternalStatus?:string; runtimeDiagnostic?:string; createdAt:number; updatedAt:number; startedAt?:number; finishedAt?:number }
